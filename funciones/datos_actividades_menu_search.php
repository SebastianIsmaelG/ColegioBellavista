    ...
    echo "<section class='container ' style='padding-top:10px;'>
            <nav aria-label='Page navigation'>
              <ul class='pagination justify-content-center'>
                ...
                for ($i=2; $i <=$ceil ; $i++) {
                  echo "<li class='page-item'><a class='page-link' id='paginacion_links' href='actividades.php?text_input_busqueda_actividades=$factor_busquedaGET&btn_bd=Busqueda&pagina=".$i."' aria-label='Goto page $i'>$i</a></li>";
                }
                //
                $condicionalDisable3="";
