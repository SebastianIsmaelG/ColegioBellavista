    ...
    try {
      ...
      if (!$cnn) {
        ...
        if ($rowCount=="0") {
          ...
          $sql = mysqli_prepare($cnn,"SELECT id_noticia,titulo_noticia,fecha_noticia,intro_noticia,foto_intro_noticia, cuerpo_noticia FROM noticias WHERE (titulo_noticia LIKE $factor_busqueda_titulo OR fecha_noticia LIKE $factor_busqueda_fecha) ORDER BY fecha_noticia DESC LIMIT ?,?");
                       ...
                       <nav aria-label='Page navigation'>
                         <ul class='pagination justify-content-center'>
                           <li class='page-item $condicionalDisable1'>
                             <a class='page-link ' id='paginacion_links' href='administrar_noticia.php?input_busqueda=$factor_busquedaGET&btn_search=Buscar&pagina=".($pagina-1)."'>&laquo; Anterior</a>
                           </li>
                           <li class='page-item'>
                             <a class='page-link ' id='paginacion_links' href='administrar_noticia.php?input_busqueda=$factor_busquedaGET&btn_search=Buscar&pagina=1' aria-label='Goto page 1'>1</a>
                           </li>";
                           for ($i=2; $i <=$ceil ; $i++) {
                             echo "<li class='page-item'><a class='page-link' id='paginacion_links' href='administrar_noticia.php?input_busqueda=$factor_busquedaGET&btn_search=Buscar&pagina=".$i."' aria-label='Goto page $i'>$i</a></li>";
                           }
                           //
                           $condicionalDisable3="";
                           ...
                           if ($pagina<=5) {
                             ...
                             if ($pagina==$total_paginas) {
                               ...
                               $i = $pagina+1;
                               echo "<li class='page-item $condicionalDisable3'><a class='page-link' id='paginacion_links' href='administrar_noticia.php?input_busqueda=$factor_busquedaGET&btn_search=Buscar&pagina=".$i."' aria-label='Goto page $i'>$i</a></li>";
                             }

                           }

                     echo "<li class='page-item $condicionalDisable2'>
                             <a class='page-link ' id='paginacion_links' href='administrar_noticia.php?input_busqueda=$factor_busquedaGET&btn_search=Buscar&pagina=".($pagina+1)."' >Siguiente &raquo;</a>
                           </li>";
             echo "</ul></nav>
                   </section>";
             ...
             if ($total_paginas>=5) {
               ...
               echo "<section class='container ' style='padding-top:10px;'>
                       <nav aria-label='Page navigation'>
                         <ul class='pagination justify-content-center'>
                           <li class='page-item $condicionalDisable1'>
                             <a class='page-link ' id='paginacion_links' href='administrar_noticia.php?pagina=".($pagina-1)."'>&laquo; Anterior</a>
                           </li>
                           <li class='page-item'>
                             <a class='page-link ' id='paginacion_links' href='administrar_noticia.php?pagina=1' aria-label='Goto page 1'>1</a>
                           </li>";
                           for ($i=2; $i <=$ceil ; $i++) {
                             echo "<li class='page-item'><a class='page-link' id='paginacion_links' href='administrar_noticia.php?pagina=".$i."' aria-label='Goto page $i'>$i</a></li>";
                           }
                           //
                           $condicionalDisable3="";
                           //11 quiero que se cuestione
                           if ($pagina<=5) {
                             ...
                             if ($pagina==$total_paginas) {
                               ...
                               $i = $pagina+1;
                               echo "<li class='page-item $condicionalDisable3'><a class='page-link' id='paginacion_links' href='administrar_noticia.php?pagina=".$i."' aria-label='Goto page $i'>$i</a></li>";
                             }

                           }

                     echo "<li class='page-item $condicionalDisable2'>
                             <a class='page-link ' id='paginacion_links' href='administrar_noticia.php?pagina=".($pagina+1)."' >Siguiente &raquo;</a>
                           </li>";
             echo "</ul></nav>
                   </section>";
