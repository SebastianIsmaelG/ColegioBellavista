      ...
      if ($titulo==""||$intro==""||$cuerpo==""||$nombre_fotografia_intro_old=="") {
        ...
        if (!$cnn) {
          ...
          if (mysqli_stmt_execute($sqlcount)==TRUE) {
            ...
            if ($contar == 0) {
              echo "<script> window.alert('Ha ocurrrido un error inesperado contacte al administrador. COD:0011');window.location.href='../paginas_administracion/menu_principal.php';</script>";
            }else {
                ...
                if ($foto_en_db == $nombre_fotografia) {
                  // code... solo actualiza db omite foto
                    ...
                    if (mysqli_stmt_execute($sql) == TRUE) {
                        ...
                        echo "<script> window.alert('Ha ocurrrido un error inesperado contacte al administrador. COD:00011');window.location.href='../paginas_administracion/menu_principal.php';</script>";
                    }
                }else {
