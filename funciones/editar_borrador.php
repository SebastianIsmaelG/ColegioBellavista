...
require ("../funciones/session_usuario.php");
 ...
 <html lang="es" dir="ltr">
   <head>
     ...
     <title>Editar Borrador CB</title>
   </head>
   <body>
     <section>
       <nav class="navbar navbar-expand-lg navbar-dark bg-primary noseleccionable">
         <a class="navbar-brand font-weight-bold text-uppercase" href="editar_noticia.php">Editar Borrador</a>
     ...
     <section>
       <div class="container py-2">
         <div class="row">
           <div class="col-lg-12">
             <div class="py-2">
               <h5 class="title_red">EDITAR BORRADOR</h5>
               <hr>
             </div>
           </div>
         </div>
       ...
       <div class="container py-2">
         <div class="row">
           <div class="col-lg-12">
             <div class="">
               <p class="font-weight-bold"> * Las publicaciones ingresadas se mostraran en orden descendente desde la que posea la fecha mas actual </p>
             </div>
           </div>
         </div>
         <div class="">
           <form action="../funciones/modificar_borrador.php" method="post" enctype="multipart/form-data">
             <div class="row">
               <div class="col-lg-12">
