                ...
                <?php
                  try {
                    if (isset($_GET["btn_bd"])) {
                      require('funciones/datos_noticias_menu_search.php');
                    }else {
                      require('funciones/datos_noticias_menu.php');
                    }

                  } catch (\Exception $e) {
                    echo "<script> alert('Ha ocurrido un error al solicitar la informacion, contacte al administrador. COD:0018');</script>";
                  }
                ?>
              </div>
              <div class="col-lg-3">
                <div class="my-2 bg-white">
                  <div class="row">
                    ...
                    <div class="col-lg-12 d-none d-lg-block">
                      <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FColegio-Bellavista-1328489143963284%2F&tabs=timeline&width=250&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId" width="250" height="600" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
                    </div>
                    <div class="col-lg-12 d-lg-none d-xl-none">
                        <!--Facebook Peque-->
                    </div>
