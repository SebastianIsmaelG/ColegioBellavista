        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="py-2 text-center">
              <form class="form-inline" action="administrar_borradores.php" method="get">
               <div class="form-group col-9">
                 <input id="input_busqueda_actividades" name="input_busqueda" class="form-control" type="text" placeholder="Filtrar por titulo publicación" style="width:100%;">
               </div>
