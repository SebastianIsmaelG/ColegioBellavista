...
<html lang="es" dir="ltr">
  <head>
    ...
    <title>Actividades Almacenadas CB</title>
  </head>
  <body>
    <section>
      ...
      <div class="container py-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Actividades Almacenadas</li>
          </ol>
        </nav>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="py-2 text-center">
               <form class="form-inline" action="administrar_actividad.php" method="get">
