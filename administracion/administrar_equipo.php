...
<html lang="es" dir="ltr">
  <head>
    ...
    <title>Datos Integrantes CB</title>
  </head>
  <body>
    <section>
      ...
      <div class="container py-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="menu_principal.php?#equipo">Seccion Equipo</a></li>
            <li class="breadcrumb-item active" aria-current="page">Datos Integrantes</li>
          </ol>
        </nav>
      </div>
    </section>
    <section>
      <div class="container py-2">
        <div class="row">
          <div class="col-lg-12">
            <div class="py-2">
              <h5 class="title_red">DATOS INTEGRANTES</h5>
              <hr>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="py-2 text-center">
              <form class="form-inline" action="administrar_equipo.php" method="get">
               <div class="form-group col-9">
                 <input id="input_busqueda_actividades" name="input_busqueda" class="form-control" type="text" placeholder="Filtrar por nombre" style="width:100%;">
               </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="py-2 text-center">
              <?php require ("../funciones/datos_integrantes.php") ?>
            </div>
          </div>
        </div>
      </div>
