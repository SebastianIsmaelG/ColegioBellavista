...
<html lang="es" dir="ltr">
  ...
  <body>
    <header style="background-color:#E03C3B;">
        ...
        <div class='container'>
          <nav class='navbar navbar-expand-lg navbar-light bg-light noseleccionable border border-white'>
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-12">
                                <div class="px-2">
                                  <div class="py-2">
                                    <a href="#" class="icon_social_contacto facebook_icon"><i class="fab fa-facebook"></i></a>
                                    <a href="#" class="icon_social_contacto instagram_icon"><i class="fab fa-instagram" color=""></i></a>
