  ...
  <body>
    <section>
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary noseleccionable">
        <a class="navbar-brand font-weight-bold text-uppercase" href="administrar_noticia.php">Noticias Almacenadas</a>
      ...
      <div class="container py-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Noticias Almacenadas</li>
          </ol>
        </nav>
      </div>
    </section>
    <section>
      ...
      <div class="container py-2">
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="py-2 text-center">
              <?php require ("../funciones/datos_noticias.php") ?>
            </div>
          </div>
        </div>
      </div>
